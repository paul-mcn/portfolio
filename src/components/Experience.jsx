	...
	return (
		<div className="text-slate-100 ">
			<Wrapper>
				...
				<div className="mt-10 flex flex-row gap-4 flex-wrap justify-center md:justify-normal">
									...
									<div className="text-slate-200 p-3 flex flex-col gap-1">
										...
										{dates && (
											<div className="text-slate-300/90 text-xs flex flex-row gap-1">
												...
												{dates.from} — {dates.to}
												<div className="text-slate-400">({dates.total})</div>
											</div>
										)}
										<div className="self-end mt-4 pt-4 mx-auto">
											<Button
